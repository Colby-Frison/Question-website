    ...
    return (
      <div className="grid grid-cols-1 gap-6">
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 text-center mb-6">
            <h4 className="text-lg font-medium mb-2 text-gray-900">Current Points</h4>
            <div className="flex justify-center items-center mb-4">
              <div id="points-display" className="text-4xl font-bold text-blue-600 transition-all transform">
                {points}
              </div>
            </div>
            
            <div className="text-sm text-blue-800 text-center mb-4">
              Total points earned in this class
            </div>
            
            {isSavingPoints && (
              <div className="mb-4 text-xs text-blue-600 flex items-center">
            ...
            <div className="w-full flex flex-col space-y-3">
              ...
              <div className="flex rounded-lg border border-gray-300 overflow-hidden">
                <input 
                  ...
                  className="flex-grow p-2 border-r border-gray-300 text-center focus:outline-none"
            ...
            <div>
              ...
              {answerSubmitted ? (
                ...
                <form onSubmit={handleAnswerSubmit} className="mt-4">
                  <div className="mb-4">
                    <label htmlFor="pointsTabAnswerText" className="block mb-2 font-semibold text-gray-900">
                      Your Answer:
                    </label>
                    <textarea
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center p-4">
          <div className="bg-white shadow-md rounded-lg p-6 max-w-md w-full">
            <h2 className="text-red-600 text-2xl font-bold mb-4">Network Error</h2>
            <p className="mb-4 text-gray-700">You are currently offline. Please check your internet connection and try again.</p>
            <button
        ...
        {!joined ? (
          <div className="min-h-[calc(100vh-120px)] flex items-center justify-center">
            <div className="max-w-sm w-full mx-auto">
              <div className="bg-white shadow-md rounded-lg overflow-hidden">
                <div className="p-8">
                  <h2 className="text-xl font-bold mb-6 text-center text-gray-900">Join a Class</h2>
                  
                  <div className="group relative mb-4">
                    <div className="flex items-center mb-1 justify-center">
                      <label htmlFor="infoSessionCode" className="block text-sm font-medium text-gray-700">
                        Session Code
                      </label>
            ...
            <div className="w-full lg:w-1/3">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-3 bg-gray-100 border border-gray-200 rounded-md text-center">
                        <p className="font-medium text-gray-700">Session Code:</p>
                        <p className="text-2xl font-bold text-blue-600">{sessionCode}</p>
                      </div>
                    </div>
                  </div>
              ...
              >
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100 transition-colors flex items-center justify-center space-x-2"
                  >
